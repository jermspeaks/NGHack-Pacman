...
$(document).ready(function() {
  ...
  // TODO Replace event listeners with websocket data packet controls
...
function animationLoop() {
  ...
  // 20 fps
  if (counter % 3 == 0) {
    toggleArrow(document.getElementById("up"));
  }
...
function toggleArrow(arrw) {
  if (arrw.style.backgroundColor == "red") {
    arrw.style.backgroundColor = "black";
  } else {
    arrw.style.backgroundColor = "red";
  }
}
